...
public class PreferredApplicationActivity extends STFragmentActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(tag != null) {
            mMenu = ST25Menu.newInstance(tag);
            if (mMenu != null) {
        ...
        Button startButton = (Button) findViewById(R.id.startToggleNFCButton);
    ...
    private void displayApplicationSettings(final String packageName) {
        ...
        String message = getString(R.string.system_setting_for_app_warning, packageName);
        ...
        alertDialogBuilder
                .setMessage(message)
                .setCancelable(true)
                .setPositiveButton(getString(R.string.open_setting),new DialogInterface.OnClickListener() {
