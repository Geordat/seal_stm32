...
public class GenericType5TagActivity extends STFragmentActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mType5Tag = (Type5Tag) super.getTag();
        if (mType5Tag == null) {
        ...
        toolbar.setTitle(mType5Tag.getName());
