...
public class ST25TAHighDensityActivity extends STFragmentActivity implements NavigationView.OnNavigationItemSelectedListener,
        STFragment.STFragmentListener {

    // Set here the Toolbar to use for this activity
    private int toolbar_res = R.menu.toolbar_empty;

    final static String TAG = "ST25TAHighDensityActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentList.add(STFragmentId.SYS_FILE_ST25TA_HIGH_DENSITY_FRAGMENT_ID);
