...
public class GenericType2Activity extends STFragmentActivity implements NavigationView.OnNavigationItemSelectedListener,
        STFragment.STFragmentListener {

    // Set here the Toolbar to use for this activity
    private int toolbar_res = R.menu.toolbar_empty;

    final static String TAG = "GenericType2Activity";
    public Type2Tag myTag;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myTag = (Type2Tag) MainActivity.getTag();
        if (myTag == null) {
