...
public class GenericType4TagActivity extends STFragmentActivity implements NavigationView.OnNavigationItemSelectedListener,
        STFragment.STFragmentListener {

    // Set here the Toolbar to use for this activity
    private int toolbar_res = R.menu.toolbar_empty;

    final static String TAG = "Type4Activity";
    public Type4Tag myTag;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myTag = (Type4Tag) MainActivity.getTag();
        if (myTag == null) {
