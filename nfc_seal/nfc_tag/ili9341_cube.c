...
/*
 ...
 /**
   * @brief  Checks if the nfctag is initialized.
 ...
 /**
   * @brief  Reads the ID of the nfctag.
   * @param  wai_id Pointer where the who_am_i of the device is stored.
   * @return NFCTAG_StatusTypeDef enum status.
   */
 ...
 /**
   * @brief  Configures the nfctag interrupt.
   * @param  ITConfig Defines the interrupt mask to be configured.
   * @details  - 0x01 => RF BUSY
   *           - 0x02 => WIP
   *           - 0x04 => RF_INTERRUPT
   *           - 0x08 => FIELD_CHANGE
   *           - 0x10 => RF_PUT_MSG
 ...
 /**
   * @brief  Reads the nfctag interrupt configutration.
   * @param  ITConfig Pointer on uint16_t used to return the interrupt configuration.
   * @details  - 0x01 => RF BUSY
   *           - 0x02 => WIP
   *           - 0x04 => RF_INTERRUPT
   *           - 0x08 => FIELD_CHANGE
 ...
 /**
   * @brief  Reads the data in the nfctag at specified address.
   * @param  pData   Pointer on the buffer used to store read data.
   * @param  TarAddr I2C data memory address to be read.
 ...
 /**
   * @brief  Writes data to the nfctag at specified address.
   * @param  pData   Pointer on the buffer containing the data to be  written.
   * @param  TarAddr I2C data memory address to be written.
   * @param  Size    Number of bytes to be written.
   * @return NFCTAG_StatusTypeDef enum status.
   */
 int32_t BSP_NFCTAG_WriteData(uint32_t Instance, const uint8_t * const pData,
 ...
 /**
   * @brief  Reads a nfctag Register.
   * @param  pData   Pointer on the buffer used to store read data.
   * @param  TarAddr I2C register address to be read.
   * @param  Size    Number of bytes to be read.
   * @return NFCTAG_StatusTypeDef enum status.
   */
 ...
 /**
   * @brief  Writes a nfctag Register.
   * @param  pData   Pointer on the buffer containing the data to be written.
   * @param  TarAddr I2C register address to written.
   * @param  Size    Number of bytes to be written.
   * @return NFCTAG_StatusTypeDef enum status.
   */
 int32_t BSP_NFCTAG_WriteRegister(uint32_t Instance, const uint8_t * const pData,
                                                         const uint16_t TarAddr, const uint16_t Size)
 {
   UNUSED(Instance);
   int32_t ret_value;
 ...
 /**
   ...
   * @param  pITtime Pointer used to return the coefficient for the GPO Pulse duration
 ...
 /**
   ...
   * @return   int32_t enum status.
   */
 int32_t BSP_NFCTAG_WriteI2CProtectZonex(uint32_t Instance, const ST25DV_PROTECTION_ZONE Zone,
 ...
 /**
   ...
   * @return int32_t enum status.
   */
 int32_t BSP_NFCTAG_WriteLockCCFile(uint32_t Instance, const ST25DV_CCFILE_BLOCK NbBlockCCFile,
 ...
 /**
   ...
   * @return int32_t enum status.
   */
 int32_t BSP_NFCTAG_ReadRFZxSS(uint32_t Instance, const ST25DV_PROTECTION_ZONE Zone,
 ...
 /**
   ...
   * @return int32_t enum status.
   */
 int32_t BSP_NFCTAG_WriteRFZxSS(uint32_t Instance, const ST25DV_PROTECTION_ZONE Zone,
 ...
 /**
   ...
   * @details  Needs the I2C Password presentation to be effective.
   * @note     The ST25DV answers a NACK when setting the EndZone2 & EndZone3 to same value
 ...
 /**
   ...
   * @details  Needs the I2C Password presentation to be effective.
   *           The ST25DV answers a NACK when setting the EndZone2 & EndZone3 to same value
   *           than repectively EndZone1 & EndZone2.
   *           These NACKs are ok.
   * @return int32_t enum status.
   */
 ...
 /**
   ...
   * @return int32_t enum status.
   */
 int32_t BSP_NFCTAG_CreateUserZone(uint32_t Instance, uint16_t Zone1Length, uint16_t Zone2Length,
 ...
 /**
   ...
   * @return int32_t enum status.
   */
 int32_t BSP_NFCTAG_ReadMailboxRegister(uint32_t Instance, uint8_t * const pData,
                                                         const uint16_t TarAddr, const uint16_t NbByte)
 {
   UNUSED(Instance);
 ...
 /**
   ...
   * @return int32_t enum status.
   */
 int32_t BSP_NFCTAG_WriteMailboxRegister(uint32_t Instance, const uint8_t * const pData,
                                                         const uint16_t TarAddr, const uint16_t NbByte)
 {
   UNUSED(Instance);
